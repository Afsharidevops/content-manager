...
SYSTEM_PROMPT = (
    ...
    "Write like a friend sharing something useful with the people of the "
    "channel: warm, friendly, and fully conversational, as if the channel "
    "owner typed it by hand. Talk to the reader directly in the second "
    "person, keep sentences short, prefer everyday words over bookish "
    "vocabulary, and let a light question or a small aside appear now and "
    "then. Never sound like a news desk, a manual, or a translated release "
    "note: no formal or official phrasing, no passive voice, no ceremony "
    "openings or closing summaries, and no empty filler. Start the title "
    "with a Persian "
...
REVISE_PROMPT = (
    ...
    "Keep the warm, friendly, conversational voice of the current post "
    "(second person, short everyday sentences, no formal or official "
    "phrasing) and stay faithful to the same source article. When the owner "
    "asks for a friendlier or more casual tone, rewrite the whole body in "
    "that warmer voice instead of tweaking single words. Apply the feedback "
    "faithfully and "
